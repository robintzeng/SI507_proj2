...
class Test_Part2(unittest.TestCase):
    ...
    def test_2_2_address(self):
        ...
        self.assertEqual(self.site_wy1.address,
    ...
    def test_2_4_str(self):
        self.assertEqual(
            self.site_mi1.info(),
            "North Country (National Scenic Trail): Lowell, MI 49331")
        self.assertEqual(
            self.site_wy1.info(),
            "Yellowstone (National Park): Yellowstone National Park, WY 82190-0168")


class Test_Part3(unittest.TestCase):
    def setUp(self):
        self.wy_list = nps.get_sites_for_state(
    ...
    def test_3_3_contents(self):
        ...
        self.assertEqual(
            self.wy_list[0].info(),
            "Bighorn Canyon (National Recreation Area): Lovell, WY 82431")


class Test_Part4(unittest.TestCase):
    def setUp(self):
        self.site_mi2 = nps.get_site_instance(
            'https://www.nps.gov/slbe/index.htm')
        self.site_wy2 = nps.get_site_instance(
